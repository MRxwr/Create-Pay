...
<div class="row">
<div class="col-xs-4">
<span class="txt-dark head-font inline-block capitalize-font mb-5"><img src="../img/fairylogo.png" style="width:100px; height:100px"></span>
<address class="mb-15">
...
while ( $row = $result->fetch_assoc() )
{
	...
	?>
<tr>
<td><?php echo $row["enTitle"] . " [".$color[$i]."] " . " [".$size[$i]."] " . " [".$length[$i]."]"  ?></td>
...
<!--<hr style="margin-top: 3px;margin-bottom:3px; border: 0.1rem solid #eee;">
<div class="row text-center" style="display:flex;justify-content: space-between;">
    <div class="col">
    </div>
    <div class="col">
        <img src="https://i.imgur.com/CVDJtgH.png" style="width:10px;height:10px"> 9118033
    </div>
    <div class="col">
        <img src="https://i.imgur.com/nnHF54J.png" style="width:10px;height:10px"> info@razzakw.com
    </div>
    <div class="col">
        <img src="https://i.imgur.com/w41mSSj.png" style="width:10px;height:10px"> https://www.razzakw.com
    </div>
    <div class="col">
    </div>
</div>
